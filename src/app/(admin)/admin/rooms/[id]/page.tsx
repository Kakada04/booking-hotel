...
import { roomService, Room, RoomDetailView } from "@/features/admin/rooms";
...
export default function AdminRoomDetailPage({
    ...
    return (
      <div className="max-w-md mx-auto text-center py-16 space-y-4 rounded-[18px] bg-white/45 backdrop-blur-xl border border-white/65 p-8 shadow-sm">
        ...
        <p className="text-xs font-normal text-muted-foreground">
          The requested room unit (&quot;{roomId}&quot;) could not be located in the PMS inventory.
        </p>
        <div>
          <Link
            href="/admin/rooms"
  ...
  return <RoomDetailView initialRoom={room} />;
}
